...
echo '-- <a href="https://tea-ette.tumblr.com">Tea (blog may be NSFW, be aware)</a> - Produced the header images you are using right now!<br/>';
echo '-- lethargicDesigner - Responsible for those lovely front page icons for gristwire and the porkhollow.<br/>';
echo '-- <a href="https://kingofaoda.tumblr.com">King of AoDA</a> - Produces the various vial graphics.<br/>';
echo '-- <a href="https://splitsoulsister.tumblr.com">Split soul sister</a> - Not actually part of the dev team, but produced the lovely Prospit background cityscape!<br/>';
echo '<br/>';
